    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.plans.new') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="features[pageviews]" id="i-features-pageview" class="form-control{{ $errors->has('features.pageviews') ? ' is-invalid' : '' }}" value="{{ old('features.pageviews') }}">
